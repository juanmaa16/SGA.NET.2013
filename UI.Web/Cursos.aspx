...
<asp:Content ID="Content1" ContentPlaceHolderID="bodyContentPlaceHolder" runat="server">
    ...
    <asp:Panel ID="formPanel" Visible="false" runat="server">
        ...
        <asp:DropDownList ID="idMateriaDDL" runat="server" DataSourceID="SqlDataSource1"
            DataTextField="desc_materia" DataValueField="id_materia">
        </asp:DropDownList>
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnStringLocal %>"
            SelectCommand="SELECT [id_materia], [desc_materia] FROM [materias]"></asp:SqlDataSource>
        <br />
        <asp:Label ID="idComision" runat="server" Text="Id Comisión: "></asp:Label>
        <asp:DropDownList ID="idComisionDDL" runat="server" DataSourceID="SqlDataSource2"
            DataTextField="desc_comision" DataValueField="id_comision">
        </asp:DropDownList>
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnStringLocal %>"
